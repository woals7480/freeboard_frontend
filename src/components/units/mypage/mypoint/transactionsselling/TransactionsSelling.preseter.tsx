...
import * as S from "./TransactionsSelling.styles";
import { ITransactionsSellingPageUIProps } from "./TransactionsSelling.types";

export default function TransactionsSellingPageUI(
  props: ITransactionsSellingPageUIProps
) {
